// Realizar una función que permita obtener el término n de la sucesión de 
// Fibonacci. La sucesión de Fibonacci es la sucesión de los siguientes 
// números:	1, 1, 2, 3, 5, 8, 13, 21, 34, ... Donde cada uno de los números 
// se calcula sumando los dos anteriores a él. Por ejemplo:
// La sucesión del número 2 se calcula sumando (1+1)
// Análogamente, la sucesión del número 3 es (1+2), Y la del 5 es (2+3),
// Y así sucesivamente... La sucesión de Fibonacci se puede formalizar de 
...
// hasta llegar a ese valor. Para conocer más acerca de la serie de Fibonacci
...
Algoritmo clase14Ejercicio12Fibonacci
	...
	Escribir "El término de ", numeroIngresado, " sucesiones de Fibonacci es"
